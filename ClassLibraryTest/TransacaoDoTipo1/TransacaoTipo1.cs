...
namespace ArquivoRemessa
{
    public class TransacaoTipo1
    {
        ...
        public string CodigoBancoDebito
        {
            ...
            set { codigoBancoDebito = FormataArquivo.FormataCampoComEspacosDireita(value, 3); }
        }
        ...
        public string IdentificacaoTituloBanco
        {
            ...
            set
            {
                ...
                identificacaoTituloBanco = FormataArquivo.FormataCampoComZerosEsquerda(value, 11);
            }
        }
        ...
        public string DigitoAutoConferencia
        {
            ...
            set { digitoAutoConferencia = FormataArquivo.FormataCampoComEspacosDireita(value, 1); }
        }
        ...
        public string CondicaoRegistroDebitoAutomatico
        {
            ...
            set { condicaoRegistroDebitoAutomatico = FormataArquivo.FormataCampoComEspacosDireita(value, 1); }
        }
        ...
        public string IndicadorRateioCredito
        {
            ...
            set { indicadorRateioCredito = FormataArquivo.FormataCampoComEspacosDireita(value, 1); }
        }
        ...
        public string EnderecamentoAvisoDebitoAutomatico
        {
            ...
            set { enderecamentoAvisoDebitoAutomatico = FormataArquivo.FormataCampoComEspacosDireita(value, 1); }
        }
        ...
        public string PagamentoParcial
        {
            ...
            set { pagamentoParcial = FormataArquivo.FormataCampoComEspacosDireita(value, 2); }
        }
        ...
        public string NumeroDocumento
        {
            ...
            set { numeroDocumento = FormataArquivo.FormataCampoComEspacosDireita(value, 10); }
        }
        ...
        public string BancoEncarregadoCobranca
        {
            ...
            set { bancoEncarregadoCobranca = FormataArquivo.FormataCampoComEspacosDireita(value, 3); }
        }
        ...
        public string AgenciaDepositaria
        {
            ...
            set { agenciaDepositaria = FormataArquivo.FormataCampoComEspacosDireita(value, 5); }
        }
        ...
        public string SegundaInstrucao
        {
            ...
            set { segundaInstrucao = FormataArquivo.FormataCampoComEspacosDireita(value, 2); }
        }
        ...
        public string NumeroInscricaoPagador
        {
            ...
            set { numeroInscricaoPagador = FormataArquivo.FormataCampoComZerosEsquerda(value, 14); }
        }
        ...
        public string NomePagador
        {
            ...
            set { nomePagador = FormataArquivo.FormataCampoComEspacosDireita(value, 40); }
        }
        ...
        public string EnderecoCompleto
        {
            ...
            set { enderecoCompleto = FormataArquivo.FormataCampoComEspacosDireita(value, 40); }
        }
        ...
        public string PrimeiraMensagem
        {
            ...
            set { primeiraMensagem = FormataArquivo.FormataCampoComEspacosDireita(value, 12); }
        }
        ...
        public string SegundaMensagem
        {
            ...
            set { segundaMensagem = FormataArquivo.FormataCampoComEspacosDireita(value, 60); }
        }
        ...
        public StringBuilder GetTransacao()
        {
            ...
            transacao.Insert(108, FormataArquivo.FormataCampoComZerosEsquerda(Convert.ToString((int)this.identificacaoOcorrencia), 2));
            transacao.Insert(110, this.numeroDocumento);
            transacao.Insert(120, FormataArquivo.FormataCampoComZerosEsquerda(this.dataVencimentoTitulo.ToString("ddMMyy"), 6));
            transacao.Insert(126, FormataArquivo.FormataCampoComZerosEsquerda(this.valorTitulo.ToString().Replace(",", ""), 13));
            transacao.Insert(139, this.bancoEncarregadoCobranca);
            transacao.Insert(142, this.agenciaDepositaria);
            transacao.Insert(147, FormataArquivo.FormataCampoComZerosEsquerda(Convert.ToString((int)this.especieTitulo), 2));
            transacao.Insert(149, identificacao);
            transacao.Insert(150, FormataArquivo.FormataCampoComZerosEsquerda(this.dataEmissaoTitulo.ToString("ddMMyy"), 6));
            transacao.Insert(156, FormataArquivo.FormataCampoComZerosEsquerda(Convert.ToString((int)this.primeiraInstrucao), 2));
            transacao.Insert(158, this.segundaInstrucao);
            transacao.Insert(160, FormataArquivo.FormataCampoComZerosEsquerda(this.valorCobrarDiaAtraso.ToString().Replace(",", ""), 13));
            ...
            {
                transacao.Insert(173, FormataArquivo.FormataCampoComZerosEsquerda(this.dataLimiteConcessaoDesconto.ToString("ddMMyy"), 6));
            }
            transacao.Insert(179, FormataArquivo.FormataCampoComZerosEsquerda(this.valorDesconto.ToString().Replace(",", ""), 13));
            transacao.Insert(192, FormataArquivo.FormataCampoComZerosEsquerda(this.valorIOF.ToString().Replace(",", ""), 13));
            transacao.Insert(205, FormataArquivo.FormataCampoComZerosEsquerda(this.valorAbatimento.ToString().Replace(",", ""), 13));
            transacao.Insert(218, FormataArquivo.FormataCampoComZerosEsquerda(Convert.ToString((int)this.identificacaoTipoInscricao), 2));
